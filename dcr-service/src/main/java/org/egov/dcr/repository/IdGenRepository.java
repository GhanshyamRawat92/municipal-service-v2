...
public class IdGenRepository {
    ...
    @Autowired
    public IdGenRepository(RestTemplate restTemplate, DcrConfiguration dcrConfiguration) {
    ...
    public IdGenerationResponse getId(RequestInfo requestInfo, String tenantId, String name, String format, int count) {
        ...
        try {
            response = restTemplate.postForObject( dcrConfiguration.getIdGenHost()+ dcrConfiguration.getIdGenPath(), req, IdGenerationResponse.class);
